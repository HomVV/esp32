...
// WiFi access point
#define WIFI_AP_NAME "Savvycom Staff"
// WiFi password
#define WIFI_PASSWORD "2014savvycom"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
#define TOKEN "I2d1mPdTaIZWaxw2XhUe"
// ThingsBoard server instance.
#define THINGSBOARD_SERVER "10.22.4.168"
